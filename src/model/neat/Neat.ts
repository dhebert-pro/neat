...
export default class Neat {
  ...
  SURVIVE_RATE = 0.8;
  PROBABILITY_MUTATE_LINK = 0.25;
  PROBABILITY_MUTATE_NODE = 0.25;
  PROBABILITY_MUTATE_WEIGHT_SHIFT = 0.25;
  PROBABILITY_MUTATE_WEIGHT_RANDOM = 0.25;
  PROBABILITY_MUTATE_TOGGLE_LINK = 0.25;
